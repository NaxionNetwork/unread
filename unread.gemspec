...
Gem::Specification.new do |s|
  ...
  s.test_files = ["spec/base_spec.rb".freeze, "spec/model/email.rb".freeze, "spec/model/reader.rb".freeze, "spec/read_mark_spec.rb".freeze, "spec/readable_spec.rb".freeze, "spec/spec_helper.rb".freeze, "spec/support/matchers/perform_queries.rb".freeze, "spec/support/query_counter.rb".freeze, "spec/support/timecop.rb".freeze]
